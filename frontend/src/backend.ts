...
export class Backend implements backendInterface {
    ...
    async decreaseStock(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.decreaseStock(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOrderForCaller(arg0: bigint): Promise<Order | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrderForCaller(arg0);
    ...
    async submitOrder(arg0: Array<[ProductId, Quantity]>): Promise<bigint> {
        if (this.processError) {
            try {
